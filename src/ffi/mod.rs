...
pub type StringAsyncCallback = unsafe extern "C" fn(
    result_json: *const c_char,
    error_cstr: *const c_char,
    status: i32,
    ctx: *mut c_void,
);
...
pub type VoidAsyncCallback =
    unsafe extern "C" fn(error_cstr: *const c_char, status: i32, ctx: *mut c_void);
